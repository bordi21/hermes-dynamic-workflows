...
Operate in read-only planning mode. Analyze the original objective, the inherited Hermes profile and project context, the relevant repository state, constraints, allowed mutations, and available evidence. Do not implement the work and do not modify files.
